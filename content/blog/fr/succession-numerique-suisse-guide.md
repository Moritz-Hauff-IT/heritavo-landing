---
title: "Succession numérique en Suisse : guide pratique 2026"
description: "Ce que dit le droit successoral suisse sur la succession numérique, quelles étapes fonctionnent juridiquement et pratiquement, et les pièges typiques. Un guide de première main."
publishedAt: "2026-05-22"
updatedAt: "2026-05-22"
keywords:
  - "succession numérique Suisse"
  - "héritage numérique suisse"
  - "procuration de prévoyance"
...
1. **Mandat pour cause d'inaptitude manuscrit**
2. **Liste des comptes importants** dans un coffre chiffré
3. **Codes de récupération** imprimés pour e-mail et banque
4. **Informer une personne de confiance**

Couvre 80% des problèmes courants.

### Package "Standard" (Demi-journée, rendez-vous notaire)

1. Tout du Minimal, plus :
2. **Mandat authentifié** (~300-500 CHF)
3. **Testament manuscrit** avec référence explicite au contenu numérique
4. **Coffre Zero-Knowledge** avec plan d'urgence automatique
5. **2-3 personnes de confiance** avec partage Shamir
...
1. Tout du Standard, plus :
2. **Testament authentifié** avec distribution concrète des actifs numériques
3. **Pacte successoral** pour familles recomposées
4. **Accompagnement par avocat** pour crypto >100k CHF
...
1. **Mandat pour cause d'inaptitude manuscrit**
2. **Liste de comptes avec codes de récupération** dans une solution chiffrée
3. **Informer une personne de confiance**

C'est 80% de la solution.

**Pour la partie numérique :** Heritavo couvre l'étape 2 (liste des comptes, codes de récupération) et l'étape 3 (personne de confiance, libération automatique) dans une solution suisse zero-knowledge. Plan Free : gratuit, 10 entrées, 1 contact d'urgence. [Essayer Heritavo Free →](/fr)

Articles liés :
- [Que deviennent vos comptes en ligne après un décès ?](/fr/blog/que-deviennent-mes-comptes-en-ligne-apres-deces)
- [Hériter des cryptos — le cas le plus fréquent de perte totale](/fr/blog/heriter-cryptos-sans-perte-totale)
- [Comment fonctionne un coffre-fort zero-knowledge avec plan d'urgence](/fr/blog/comment-fonctionne-coffre-fort-zero-knowledge-plan-urgence)
